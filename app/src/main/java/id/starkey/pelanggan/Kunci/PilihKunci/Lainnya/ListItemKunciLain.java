...
public class ListItemKunciLain {
    ...
    public ListItemKunciLain(String id, String nama_kunci, String merk, String harga_kunci, String biaya_layanan, String harga, String gambar) {
        this.id = id;
